...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Jan 2026 pada 07.40
...
INSERT INTO `absensi` (`id_absen`, `id_siswa`, `tanggal`, `status`) VALUES
(1, 1, '2025-08-21', 'Hadir'),
(2, 1, '2026-01-12', 'Alpha');
...
INSERT INTO `guru` (`id_guru`, `nip`, `nama`, `mapel`) VALUES
(1, '12345', 'Pak Budi', 'Matematika');
